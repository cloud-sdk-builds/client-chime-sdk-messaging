...
[`@aws-sdk/client-chime-sdk-messaging`](https://www.npmjs.com/package/@aws-sdk/client-chime-sdk-messaging/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-messaging@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+1ei8I4EQbKNO3Pr+cveR+uQRNab4/8BRRunoC+CL7obe1Lx0GUCxp0wVI+L/yNX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-chime-sdk-messaging": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-messaging@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-messaging@3.996.0/index.min.mjs": "sha384-+1ei8I4EQbKNO3Pr+cveR+uQRNab4/8BRRunoC+CL7obe1Lx0GUCxp0wVI+L/yNX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-chime-sdk-messaging/blob/refs/tags/3.996.0/LICENSE
```
